...
// static void	skip_env(char const *str, size_t *index)
// {
// 	const size_t	len = ft_strlen(str);

// 	(*index)++;
// 	while (*index < len && !((str[*index] == '$' || is_space_or_tab(str[*index])
// 		|| ft_strchr(SYMBOL_CHARS, str[*index])) && !is_escaped(str, *index)))
// 	{
// 		(*index)++;
// 	}
// 	(*index)++;
...
// 			if (replace_dollar_value(env, envp, 0)[0] != '\0'
// 				|| ft_strequal(env, DOLLAR_Q))
